    ...
    const BtnShow = () => { 
        if (publicAddress == '') {
            return  <Nav.Link href="#pricing">
                        <Button ref={target} onClick={onConnect}>
                            Start
                        </Button> 
                    </Nav.Link>
        }
    ...
    <> <Container>
      <Row>
        ...
        <Col className='right-area'>
            <Navbar bg="dark" variant="dark" className='right'>
                <Container>
                    <Nav className="me-auto">
                        ...
                        <NavDropdown title="Guide" id="basic-nav-dropdown" className='mTop5'>
                            <NavDropdown.Item href="/start">Start</NavDropdown.Item>
                            <NavDropdown.Item href="/faq">FAQ</NavDropdown.Item>
                            <NavDropdown.Item href="/blog">Blog</NavDropdown.Item>     
                            {/* <NavDropdown.Item href="/about">About Us </NavDropdown.Item>    */}
                        </NavDropdown>
                        <Nav.Link href="/about"  className='mTop5'>
                            About Us    
                        </Nav.Link>
